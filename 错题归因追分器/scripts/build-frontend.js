...
async function buildFrontend() {
  ...
  await fs.promises.copyFile(path.join(projectRoot, 'shared', 'hzq.js'), path.join(sharedDir, 'hzq.js'));
  await fs.promises.copyFile(path.join(projectRoot, 'shared', 'jx-brand.css'), path.join(sharedDir, 'jx-brand.css'));
